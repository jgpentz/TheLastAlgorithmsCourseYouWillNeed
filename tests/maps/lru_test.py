...
class TestLRU:
    ...
    def test_lru_length_does_not_exceed_capacity(self, values: List[int], keys: List[int], capacity: int) -> None:
        # Given
        lru = LRU(capacity)
    ...
    def test_lru_update_nodes_value(self, values: List[int], keys: List[int], capacity: int, new_value: int) -> None:
        # Given
        lru = LRU(capacity)
    ...
    def test_lru_get_value_will_not_be_dropped(self, values: List[int], keys: List[int], capacity: int) -> None:
        # Given
        lru = LRU(capacity)
    ...
    def test_lru_update_existing_value(self, values: List[int], keys: List[int], capacity: int, new_value: int) -> None:
        # Given
        lru = LRU(capacity)
